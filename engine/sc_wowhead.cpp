...
static js_node_t* download_profile( sim_t* sim,
                                    const std::string& id )
{
  std::string url_www = "http://wotlk.evowow.com/profile=load&id=" + id;
  std::string url_ptr = "http://wotlk.evowow.com/profile=load&id=" + id;
  std::string result;
                                ...
                                int cache_only=0 )
{
  ...
  std::string url_www = "http://wotlk.evowow.com/item=" + id_str + "&xml";
  std::string url_ptr = "http://wotlk.evowow.com/item=" + id_str + "&xml";
                                      ...
                                      int use_active_talents )
{
  ...
  if ( builds ) // !!! NEW FORMAT !!!
  {
    ...
    p->talents_str = "https://iradei.eu/talent-calculators/wotlk/" + p->type + '?' + talent_encoding;
  ...
  else // !!! OLD FORMAT !!!
  {
	...
	return 0;
      ...
      p->talents_str = "https://iradei.eu/talent-calculators/wotlk/" + p->type + '?' + encoding;
    }
